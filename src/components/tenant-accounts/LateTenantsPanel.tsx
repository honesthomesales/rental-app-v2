...
type LateTenantsPanelProps = {
  /** When true, hide the standalone page title (parent Tenant Accounts shell owns chrome). */
  embedded?: boolean
}

export default function LateTenantsPanel({ embedded = false }: LateTenantsPanelProps) {
  // Manual Text Tenant always available; provider send remains flagged server-side.
