-- ============================================
-- LINK UNLINKED PAYMENTS TO INVOICES
-- ============================================
-- Problem: 839 invoices have payments but only 29 have linked payment records
-- Solution: Run FIFO allocation RPC for all unlinked payments
-- ============================================

-- STEP 1: DIAGNOSTIC - See how many unlinked payments exist
SELECT 
...
-- STEP 3: FIX - Run FIFO allocation for all unlinked payments
-- This script processes payments one at a time to avoid errors
...
-- STEP 4: VERIFICATION - Check results after running Step 3
SELECT 
...
-- After linking payments, recalculate all affected invoices
-- This ensures amount_paid and balance_due are correct
...
-- Check that invoices now have correct balances
SELECT 
