...
export const MESSAGE_TEMPLATES: MessageTemplate[] = [
  ...
  },
  {
    ...
    label: "Eviction-Risk Warning",
    body: "Your account remains past due and may be referred for eviction or other legal action. Please contact Honest Home Sales immediately to discuss payment. Reply STOP to unsubscribe.",
